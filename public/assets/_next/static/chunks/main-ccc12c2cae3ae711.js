        ...
        function u(e) {
          {
            ...
            const basePath = 'public/assets/_next'; // Define the correct base path
            const scriptUrl = `${basePath}${e}`; // Construct the full script URL
            
            
            return (
              n ||
              (document.querySelector(`script[^="${scriptUrl}"]`)
                ? Promise.resolve()
                : (r.set(
                    e.toString(),
                    (n = new Promise((resolve, reject) => {
                      ...
                      t.crossOrigin = 'anonymous'; // Set crossOrigin if needed
                      t.src = scriptUrl;
...
// Select all elements with the class 'hover-target-edge1'
const hoverTargets1 = document.querySelectorAll('.hover-target-edge1');

// Function to add hover class
const applyHoverEffect1 = () => {
  hoverTargets1.forEach(target => {
    target.classList.add('hovered1');
  });
};

// Function to remove hover class
const removeHoverEffect1 = () => {
  hoverTargets1.forEach(target => {
    target.classList.remove('hovered1');
  });
};

// Add event listeners to all hover targets
hoverTargets1.forEach(target => {
  target.addEventListener('mouseenter', applyHoverEffect1);
  target.addEventListener('mouseleave', removeHoverEffect1);
});

// Select all elements with the class 'hover-target-edge2'
const hoverTargets2 = document.querySelectorAll('.hover-target-edge2');

// Function to add hover class
const applyHoverEffect2 = () => {
  hoverTargets2.forEach(target => {
    target.classList.add('hovered2');
  });
};

// Function to remove hover class
const removeHoverEffect2 = () => {
  hoverTargets2.forEach(target => {
    target.classList.remove('hovered2');
  });
};

// Add event listeners to all hover targets
hoverTargets2.forEach(target => {
  target.addEventListener('mouseenter', applyHoverEffect2);
  target.addEventListener('mouseleave', removeHoverEffect2);
});

// Select all elements with the class 'hover-target-edge3'
const hoverTargets3 = document.querySelectorAll('.hover-target-edge3');

// Function to add hover class
const applyHoverEffect3 = () => {
  hoverTargets3.forEach(target => {
    target.classList.add('hovered3');
  });
};

// Function to remove hover class
const removeHoverEffect3 = () => {
  hoverTargets3.forEach(target => {
    target.classList.remove('hovered3');
  });
};

// Add event listeners to all hover targets
hoverTargets3.forEach(target => {
  target.addEventListener('mouseenter', applyHoverEffect3);
  target.addEventListener('mouseleave', removeHoverEffect3);
});

// Select all elements with the class 'hover-target-contact'
const hoverTargetsC = document.querySelectorAll('.hover-target-contact');

// Function to add hover class
const applyHoverEffectC = () => {
  hoverTargetsC.forEach(target => {
    target.classList.add('hoveredC');
  });
};

// Function to remove hover class
const removeHoverEffectC = () => {
  hoverTargetsC.forEach(target => {
    target.classList.remove('hoveredC');
  });
};
// Add event listeners to all hover targets
hoverTargetsC.forEach(target => {
  target.addEventListener('mouseenter', applyHoverEffectC);
  target.addEventListener('mouseleave', removeHoverEffectC);
});


// Select all elements you want to use as hover targets
const hoverTargetsW = document.querySelectorAll('.project-text-hover');

// Select the element you want to modify
const affectedDiv1 = document.querySelector('.projects-text');

// Function to add hover class to the affected element
const applyHoverEffectW = () => {
  affectedDiv1.classList.add('projects-visibility');
};

// Function to remove hover class from the affected element
const removeHoverEffectW = () => {
  affectedDiv1.classList.remove('projects-visibility');
};

// Add event listeners to all hover targets
hoverTargets1.forEach(target => {
  target.addEventListener('mouseenter', applyHoverEffectW);
  target.addEventListener('mouseleave', removeHoverEffectW);
});


// Select all elements you want to use as hover targets
const hoverTargetsA = document.querySelectorAll('.about-text-hover');

// Select the element you want to modify
const affectedDiv2 = document.querySelector('.about-text');

// Function to add hover class to the affected element
const applyHoverEffectA = () => {
  affectedDiv2.classList.add('about-visibility');
};

// Function to remove hover class from the affected element
const removeHoverEffectA = () => {
  affectedDiv2.classList.remove('about-visibility');
};

// Add event listeners to all hover targets
hoverTargetsA.forEach(target => {
  target.addEventListener('mouseenter', applyHoverEffectA);
  target.addEventListener('mouseleave', removeHoverEffectA);
});


// Select all elements you want to use as hover targets
const hoverTargetsP = document.querySelectorAll('.principles-text-hover');

// Select the element you want to modify
const affectedDiv3 = document.querySelector('.principles-text');

// Function to add hover class to the affected element
const applyHoverEffectP = () => {
  affectedDiv3.classList.add('principles-visibility');
};

// Function to remove hover class from the affected element
const removeHoverEffectP = () => {
  affectedDiv3.classList.remove('principles-visibility');
};

// Add event listeners to all hover targets
hoverTargetsP.forEach(target => {
  target.addEventListener('mouseenter', applyHoverEffectP);
  target.addEventListener('mouseleave', removeHoverEffectP);
});